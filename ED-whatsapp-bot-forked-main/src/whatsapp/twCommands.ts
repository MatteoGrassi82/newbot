...
import chatGPTService from '../openai/assistant';
...
export async function commands(message: Message, client: Client): Promise<void> {
  ...
  if (!isUserRegistered(sender)) {
    ...
    client.sendMessage(sender, "Hey! 👋 I'm Ed, your friendly chat buddy for all things bipolar disorder.\n Whether you send voice notes or text, I'm here to listen and help make things clearer.\nWhat's on your mind?", { mentions: [contact] });
